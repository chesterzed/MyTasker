...
ACTION_SET_PLAN = "📋 План для «{title}» ({count} шагов)"
ACTION_STEP_DONE = "☑️ Отметить шаг «{title}»"
ACTION_STEP_UNDONE = "↩️ Снять отметку с шага «{title}»"
ACTION_STEP_PROGRESS = "📈 Шаг «{title}»: прогресс {progress}"
...
RESULT_PLAN_SET = "📋 План «{title}» обновлён ({count} шагов)"
RESULT_STEP_UPDATED = "☑️ Шаг «{title}» обновлён"

# Планы целей (/aims → кнопки «n 📄»)
PLAN_HEADER = "📋 <b>План: {title}</b>"
PLAN_EMPTY = "Плана пока нет. Могу составить — нажми кнопку ниже."
PLAN_GENERATING = "🪄 Составляю план…"
PLAN_GEN_FAILED = "Не получилось составить план. Попробуй ещё раз."
BTN_PLAN_BACK = "⬅️ Назад"
BTN_PLAN_GEN = "🪄 Составить план"
STEP_DONE_ANSWER = "Отмечено ✅"
STEP_UNDONE_ANSWER = "Отметка снята"
ADDAIM_PLAN_SAVED = "📋 Составил план ({count} шагов) — смотри /aims"
